...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends DateTime::TimeZone
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends DateTime::TimeZone
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/DateTime-TimeZone).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=DateTime-TimeZone)
or [via email](bug-datetime-timezone@rt.cpan.org.
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.47.
