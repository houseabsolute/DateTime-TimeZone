...
zone does not have I<any> offset, and is always the same time.  This is
...
occurs.  See L<RFC 2445|https://www.ietf.org/rfc/rfc2445.txt> for more details.
...
floating time zone, as defined by L<RFC 2445|https://www.ietf.org/rfc/rfc2445.txt>.
